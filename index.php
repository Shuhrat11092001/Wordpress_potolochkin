    ...
    <div class="container">
        <div class="map-head">
            ...
            <div class="map-title">
                ...
                <h1>Мы рядом</h1>
                <p>Наш замерщик со всем необходимым для выбора и расчета стоимости потолка приедет к вам в любую точку <span>Москвы</span> и до 30 км от нее совершенно бесплатно. Если вы живете дальше, он, конечно, тоже к вам приедет, но за небольшую плату.
                </p>
            </div>
...
var map = L.map('map', {
    ...
    zoom: 13,
    zoomControl: false,           // Отключить элементы управления масштабированием
    scrollWheelZoom: false,       // Отключить увеличение с помощью колесика мыши
    doubleClickZoom: false,       // Отключить увеличение по двойному щелчку
    dragging: false,              // Отключить перетаскивание карты
    touchZoom: false,             // Отключить увеличение касанием
    boxZoom: false                // Отключить увеличение рамкой
});
...
// Первоначальное добавление изображений
addImageOverlays();

// Обновление карты с использованием значения переменной city
updateMap(city);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    addToFavoritesButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            likeButtonImage.src = "<?php echo get_stylesheet_directory_uri();?>/assets/icons/red_heart.png"; // Замените на путь к вашему новому изображению
            addToFavorites(card);
        });
    });
    ...
    function addToFavorites(card) {
        ...
        newBlock.innerHTML = '<div class="card__images_item1 d-flex align-items-center gap-3"><img src="<?php echo get_stylesheet_directory_uri();?>/assets/icons/close_open.png" loading="lazy" alt=""><p>Потолок вот такой</p></div>';
